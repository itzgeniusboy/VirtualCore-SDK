        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            if (resolveInfo == null) {
                ...
                if (intent.getPackage() == null && intent.getComponent() == null) {
                    // ✅ Fix: Allow external resolution for Facebook, Discord, and Google OAuth
                    String action = intent.getAction();
                    boolean isAuthIntent = false;
                    if (action != null) {
                        String lowerAction = action.toLowerCase();
                        if (lowerAction.contains("facebook") || lowerAction.contains("discord") || lowerAction.contains("google") || lowerAction.contains("auth")) {
                            isAuthIntent = true;
                        }
                    }
                    ...
                    if (!isAuthIntent) {
                        ...
                        Slog.d(TAG, "Auth intent detected, allowing external resolution: " + action);
                    }
                } else {
